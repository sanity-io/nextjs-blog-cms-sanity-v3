...
export declare namespace Schema {
     ...
     */
    export type IntrinsicTypeDefinition = ArrayDefinition | BlockDefinition | BooleanDefinition | DateDefinition | DatetimeDefinition | DocumentDefinition | FileDefinition | GeopointDefinition | ImageDefinition | NumberDefinition | ObjectDefinition | ReferenceDefinition | CrossDatasetReferenceDefinition | SlugDefinition | StringDefinition | SpanDefinition | TextDefinition | UrlDefinition;
    /**
     ...
     * itself.
     */
    export type TypeDefinition<TType extends Type = Type> = Extract<IntrinsicTypeDefinition, {
        type: TType;
     ...
     */
    export type FieldDefinition<TType extends Type = Type> = (Extract<IntrinsicTypeDefinition, {
        type: TType;
    }> | TypeReference<TType>) & {
        name: string;
        title?: string;
    ...
    export type TypeOptions<T extends Type> = T extends 'array' ? ArrayOptions : T extends 'block' ? BlockOptions : T extends 'boolean' ? BooleanOptions : T extends 'date' ? DateOptions : T extends 'datetime' ? DatetimeOptions : T extends 'file' ? FileOptions : T extends 'image' ? ImageOptions : T extends 'number' ? NumberOptions : T extends 'object' ? ObjectOptions : T extends 'reference' ? ReferenceOptions : T extends 'crossDatasetReference' ? CrossDatasetReferenceDefinition : T extends 'slug' ? SlugOptions : T extends 'string' ? StringOptions : never;
...
export declare function defineType<TType extends string>(schemaDefinition: Schema.TypeAliasDefinition): Schema.TypeAliasDefinition;
export declare function defineType<TType extends Schema.Type>(schemaDefinition: Extract<Schema.IntrinsicTypeDefinition, {
    type: TType;
}>): Extract<Schema.IntrinsicTypeDefinition, {
    type: TType;
}>;
export declare function defineField<TType extends Schema.Type>(schemaField: Schema.FieldDefinition<TType>): Schema.FieldDefinition<TType>;
/**
 * Note: you probably want `SchemaTypeDefinition` instead
 * @see SchemaTypeDefinition
 */
export declare type SchemaType = ArraySchemaType | BooleanSchemaType | FileSchemaType | NumberSchemaType | ObjectSchemaType | StringSchemaType | ReferenceSchemaType;
/**
 ...
 * itself.
 */
export declare type SchemaTypeDefinition<TType extends Schema.Type = Schema.Type> = Schema.TypeDefinition<TType>;
...
export declare type InitialValueResolver<Params, Value> = (params: Params | undefined, context: InitialValueResolverContext) => Promise<Value> | Value;
export declare type InitialValueProperty<Params, Value> = Value | InitialValueResolver<Params, Value> | undefined;
/**
...
export declare type ArraySchemaTypeOf<TSchemaType extends ArraySchemaType['of'][number]> = Omit<ArraySchemaType, 'of'> & {
    of: TSchemaType[];
};
/**
