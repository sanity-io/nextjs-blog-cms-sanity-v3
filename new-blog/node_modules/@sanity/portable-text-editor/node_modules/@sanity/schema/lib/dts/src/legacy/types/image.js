...
export var ImageType = {
    ...
    extend: function (subTypeDef, extendMember) {
        ...
        var fields = __spreadArray(__spreadArray([ASSET_FIELD], __read(hotspotFields), false), __read((subTypeDef.fields || [])), false);
        var parsed = Object.assign(pick(IMAGE_CORE, OVERRIDABLE_FIELDS), subTypeDef, {
            type: IMAGE_CORE,
