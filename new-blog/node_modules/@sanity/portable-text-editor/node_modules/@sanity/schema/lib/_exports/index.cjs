...
var OVERRIDABLE_FIELDS$e = tslib_es6.__spreadArray([], tslib_es6.__read(DEFAULT_OVERRIDEABLE_FIELDS), false);
var ANY_CORE = {
    name: 'any',
    type: null,
    jsonType: 'any',
...
var AnyType = {
    ...
    extend: function (subTypeDef, extendMember) {
        var parsed = Object.assign(lodash.pick(ANY_CORE, OVERRIDABLE_FIELDS$e), subTypeDef, {
            type: ANY_CORE,
        ...
        function subtype(parent) {
            return {
                ...
                extend: function (extensionDef) {
                    ...
                    var current = Object.assign({}, parent, lodash.pick(extensionDef, OVERRIDABLE_FIELDS$e), {
                        type: parent,
                    });
...
var OVERRIDABLE_FIELDS$d = tslib_es6.__spreadArray([], tslib_es6.__read(DEFAULT_OVERRIDEABLE_FIELDS), false);
var STRING_CORE = {
    name: 'string',
    title: 'String',
    type: null,
...
var StringType = {
    ...
    extend: function (subTypeDef) {
        var parsed = Object.assign(lodash.pick(STRING_CORE, OVERRIDABLE_FIELDS$d), subTypeDef, {
            type: STRING_CORE,
        ...
        function subtype(parent) {
            return {
                ...
                extend: function (extensionDef) {
                    var current = Object.assign({}, parent, lodash.pick(extensionDef, OVERRIDABLE_FIELDS$d), {
                        type: parent,
                    });
                    return subtype(current);
                },
...
var OVERRIDABLE_FIELDS$c = tslib_es6.__spreadArray(tslib_es6.__spreadArray([], tslib_es6.__read(DEFAULT_OVERRIDEABLE_FIELDS), false), ['rows'], false);
var TEXT_CORE = {
    name: 'text',
    title: 'Text',
    type: null,
...
var TextType = {
    ...
    extend: function (subTypeDef) {
        var parsed = Object.assign(lodash.pick(TEXT_CORE, OVERRIDABLE_FIELDS$c), subTypeDef, {
            type: TEXT_CORE,
            preview: primitivePreview,
        });
        return subtype(parsed);
        function subtype(parent) {
            return {
                ...
                extend: function (extensionDef) {
                    var current = Object.assign({}, parent, lodash.pick(extensionDef, OVERRIDABLE_FIELDS$c), {
                        type: parent,
                    });
                    return subtype(current);
                },
...
var OVERRIDABLE_FIELDS$b = tslib_es6.__spreadArray([], tslib_es6.__read(DEFAULT_OVERRIDEABLE_FIELDS), false);
var DATETIME_CORE = {
    name: 'datetime',
    title: 'Datetime',
    type: null,
...
var DateTimeType = {
    ...
    extend: function (subTypeDef) {
        var parsed = Object.assign(lodash.pick(DATETIME_CORE, OVERRIDABLE_FIELDS$b), subTypeDef, {
            type: DATETIME_CORE,
            preview: primitivePreview,
        });
        return subtype(parsed);
        function subtype(parent) {
            return {
                ...
                extend: function (extensionDef) {
                    var current = Object.assign({}, parent, lodash.pick(extensionDef, OVERRIDABLE_FIELDS$b), {
                        type: parent,
                    });
                    return subtype(current);
                },
...
var OVERRIDABLE_FIELDS$a = tslib_es6.__spreadArray([], tslib_es6.__read(DEFAULT_OVERRIDEABLE_FIELDS), false);
var DATE_CORE = {
    name: 'date',
    title: 'Datetime',
    type: null,
...
var DateType = {
    ...
    extend: function (subTypeDef) {
        var parsed = Object.assign(lodash.pick(DATE_CORE, OVERRIDABLE_FIELDS$a), subTypeDef, {
            type: DATE_CORE,
            preview: primitivePreview,
        });
        return subtype(parsed);
        function subtype(parent) {
            return {
                ...
                extend: function (extensionDef) {
                    var current = Object.assign({}, parent, lodash.pick(extensionDef, OVERRIDABLE_FIELDS$a), {
                        type: parent,
                    });
                    return subtype(current);
                },
...
var OVERRIDABLE_FIELDS$9 = tslib_es6.__spreadArray([], tslib_es6.__read(DEFAULT_OVERRIDEABLE_FIELDS), false);
var BOOLEAN_CORE = {
    name: 'boolean',
    title: 'Boolean',
    type: null,
...
var BooleanType = {
    ...
    extend: function (subTypeDef) {
        var parsed = Object.assign(lodash.pick(BOOLEAN_CORE, OVERRIDABLE_FIELDS$9), subTypeDef, {
            type: BOOLEAN_CORE,
            preview: primitivePreview,
        });
        return subtype(parsed);
        function subtype(parent) {
            return {
                ...
                extend: function (extensionDef) {
                    var current = Object.assign({}, parent, lodash.pick(extensionDef, OVERRIDABLE_FIELDS$9), {
                        type: parent,
                    });
                    return subtype(current);
                },
...
var OVERRIDABLE_FIELDS$8 = tslib_es6.__spreadArray([], tslib_es6.__read(DEFAULT_OVERRIDEABLE_FIELDS), false);
var URL_CORE = {
    name: 'url',
    title: 'Url',
    type: null,
...
var UrlType = {
    ...
    extend: function (subTypeDef) {
        var parsed = Object.assign(lodash.pick(URL_CORE, OVERRIDABLE_FIELDS$8), subTypeDef, {
            type: URL_CORE,
            preview: primitivePreview,
        });
        return subtype(parsed);
        function subtype(parent) {
            return {
                ...
                extend: function (extensionDef) {
                    var current = Object.assign({}, parent, lodash.pick(extensionDef, OVERRIDABLE_FIELDS$8), {
                        type: parent,
                    });
                    return subtype(current);
                },
...
var OVERRIDABLE_FIELDS$7 = tslib_es6.__spreadArray([], tslib_es6.__read(DEFAULT_OVERRIDEABLE_FIELDS), false);
var EMAIL_CORE = {
    name: 'email',
    title: 'Email',
    type: null,
...
var EmailType = {
    ...
    extend: function (subTypeDef) {
        var parsed = Object.assign(lodash.pick(EMAIL_CORE, OVERRIDABLE_FIELDS$7), subTypeDef, {
            type: EMAIL_CORE,
            preview: primitivePreview,
        });
        return subtype(parsed);
        function subtype(parent) {
            return {
                ...
                extend: function (extensionDef) {
                    var current = Object.assign({}, parent, lodash.pick(extensionDef, OVERRIDABLE_FIELDS$7), {
                        type: parent,
                    });
                    return subtype(current);
                },
...
var OVERRIDABLE_FIELDS$6 = tslib_es6.__spreadArray([], tslib_es6.__read(DEFAULT_OVERRIDEABLE_FIELDS), false);
var NUMBER_CORE = {
    name: 'number',
    title: 'Number',
    type: null,
...
var NumberType = {
    ...
    extend: function (subTypeDef) {
        var parsed = Object.assign(lodash.pick(NUMBER_CORE, OVERRIDABLE_FIELDS$6), subTypeDef, {
            type: NUMBER_CORE,
            preview: primitivePreview,
        });
        return subtype(parsed);
        function subtype(parent) {
            return {
                ...
                extend: function (extensionDef) {
                    var current = Object.assign({}, parent, lodash.pick(extensionDef, OVERRIDABLE_FIELDS$6), {
                        type: parent,
                    });
                    return subtype(current);
                },
...
var DESCRIPTION_CANDIDATES = tslib_es6.__spreadArray(['description'], tslib_es6.__read(TITLE_CANDIDATES), false);
function fieldHasReferenceTo(fieldDef, refType) {
    return arrify__default["default"](fieldDef.to || []).some(function (memberTypeDef) { return memberTypeDef.type === refType; });
}
...
function guessPreviewFields(rawObjectTypeDef) {
    var objectTypeDef = tslib_es6.__assign({ fields: [] }, rawObjectTypeDef);
...
function parsePreview(preview) {
    ...
    if (Array.isArray(select)) {
        return tslib_es6.__assign(tslib_es6.__assign({}, lodash.pick(preview, ['prepare', 'component'])), { select: parseSelection(select) });
    }
    return tslib_es6.__assign(tslib_es6.__assign({}, lodash.pick(preview, ['prepare', 'component'])), { select: select });
}
...
function getCachedStringFieldPaths(type, maxDepth) {
    if (!type[stringFieldsSymbol]) {
        type[stringFieldsSymbol] = lodash.uniqBy(tslib_es6.__spreadArray(tslib_es6.__spreadArray(tslib_es6.__spreadArray(tslib_es6.__spreadArray([], tslib_es6.__read(BASE_WEIGHTS), false), tslib_es6.__read(deriveFromPreview(type)), false), tslib_es6.__read(getStringFieldPaths(type, maxDepth).map(function (path) { return ({ weight: 1, path: path }); })), false), tslib_es6.__read(getPortableTextFieldPaths(type, maxDepth).map(function (path) { return ({
            weight: 1,
            path: path,
            mapWith: 'pt::text',
...
function getStringFieldPaths(type, maxDepth) {
    var reducer = function (accumulator, childType, path) {
        return childType.jsonType === 'string' ? tslib_es6.__spreadArray(tslib_es6.__spreadArray([], tslib_es6.__read(accumulator), false), [path], false) : accumulator;
    };
    return reduceType(type, reducer, [], [], maxDepth);
}
function getPortableTextFieldPaths(type, maxDepth) {
    var reducer = function (accumulator, childType, path) {
        return isPortableTextArray(childType) ? tslib_es6.__spreadArray(tslib_es6.__spreadArray([], tslib_es6.__read(accumulator), false), [path], false) : accumulator;
    };
    return reduceType(type, reducer, [], [], maxDepth);
}
...
var OVERRIDABLE_FIELDS$5 = tslib_es6.__spreadArray(tslib_es6.__spreadArray([], tslib_es6.__read(DEFAULT_OVERRIDEABLE_FIELDS), false), [
    'orderings',
...
var ObjectType = {
    ...
    extend: function (rawSubTypeDef, createMemberType) {
        var subTypeDef = tslib_es6.__assign({ fields: [] }, rawSubTypeDef);
        var options = tslib_es6.__assign({}, (subTypeDef.options || {}));
        var parsed = Object.assign(lodash.pick(this.get(), OVERRIDABLE_FIELDS$5), subTypeDef, {
            type: this.get(),
            ...
            fields: subTypeDef.fields.map(function (fieldDef) {
                var name = fieldDef.name, fieldset = fieldDef.fieldset, group = fieldDef.group, rest = tslib_es6.__rest(fieldDef, ["name", "fieldset", "group"]);
                var compiledField = {
                    name: name,
                    group: group,
                    fieldset: fieldset,
                ...
                return lazyGetter(compiledField, 'type', function () {
                    return createMemberType(tslib_es6.__assign(tslib_es6.__assign({}, rest), { title: fieldDef.title || lodash.startCase(name) }));
                });
            }),
        });
        ...
        function subtype(parent) {
            return {
                ...
                extend: function (extensionDef) {
                    ...
                    var current = Object.assign({}, parent, lodash.pick(extensionDef, OVERRIDABLE_FIELDS$5), {
...
function createFieldsets(typeDef, fields) {
    ...
    var fieldsetsByName = lodash.keyBy(fieldsets, 'name');
    return fields
        .map(function (field) {
        if (field.fieldset) {
...
function createFieldsGroups(typeDef, fields) {
    ...
    if (defaultGroups.length > 1) {
        ...
        throw new Error("You currently have ".concat(defaultGroups.length, " default field groups defined for type '").concat(typeDef.name ? lodash.startCase(typeDef.name) : (_a = typeDef.title) !== null && _a !== void 0 ? _a : "", "', but only 1 is supported"));
    }
    var groupsByName = lodash.keyBy(groups, 'name');
    fields.forEach(function (field) {
        if (field.group) {
            var fieldGroupNames = lodash.castArray(field.group);
    ...
    return lodash.flatMap(groupsByName).filter(function (group) { return group.fields.length > 0; });
}
...
var OVERRIDABLE_FIELDS$4 = tslib_es6.__spreadArray([], tslib_es6.__read(DEFAULT_OVERRIDEABLE_FIELDS), false);
var REFERENCE_CORE = {
    name: 'reference',
    title: 'Reference',
    type: null,
...
function buildTitle$1(type) {
    ...
    return "Reference to ".concat(humanize$1(arrify__default["default"](type.to).map(function (toType) { return toType.title; }), 'or').toLowerCase());
}
var ReferenceType = {
    get: function () {
    ...
    extend: function (subTypeDef, createMemberType) {
        ...
        var parsed = Object.assign(lodash.pick(REFERENCE_CORE, OVERRIDABLE_FIELDS$4), subTypeDef, {
            type: REFERENCE_CORE,
        });
        lazyGetter(parsed, 'fields', function () {
            return REFERENCE_FIELDS$1.map(function (fieldDef) {
                var name = fieldDef.name, type = tslib_es6.__rest(fieldDef, ["name"]);
                return {
                    name: name,
        ...
        lazyGetter(parsed, 'to', function () {
            return arrify__default["default"](subTypeDef.to).map(function (toType) { return createMemberType(toType); });
        });
        ...
        function subtype(parent) {
            return {
                ...
                extend: function (extensionDef) {
                    ...
                    var current = Object.assign({}, parent, lodash.pick(extensionDef, OVERRIDABLE_FIELDS$4), {
                        type: parent,
                    });
                    return subtype(current);
                },
...
var OVERRIDABLE_FIELDS$3 = tslib_es6.__spreadArray([], tslib_es6.__read(DEFAULT_OVERRIDEABLE_FIELDS), false);
...
function buildTitle(type) {
    ...
    return "Cross dataset reference to ".concat(humanize(arrify__default["default"](type.to).map(function (toType) { return toType.title || lodash.capitalize(toType.type); }), 'or').toLowerCase());
}
var CrossDatasetReferenceType = {
    ...
    extend: function (subTypeDef, createMemberType) {
        ...
        var parsed = Object.assign(lodash.pick(CROSS_DATASET_REFERENCE_CORE, OVERRIDABLE_FIELDS$3), subTypeDef, {
        ...
        lazyGetter(parsed, 'to', function () {
            return arrify__default["default"](subTypeDef.to).map(function (toType) {
                return tslib_es6.__assign(tslib_es6.__assign({}, toType), { 
        ...
        function subtype(parent) {
            return {
                ...
                extend: function (extensionDef) {
                    ...
                    var current = Object.assign({}, parent, lodash.pick(extensionDef, OVERRIDABLE_FIELDS$3), {
                        type: parent,
                    });
                    return subtype(current);
                },
...
var OVERRIDABLE_FIELDS$2 = tslib_es6.__spreadArray([], tslib_es6.__read(DEFAULT_OVERRIDEABLE_FIELDS), false);
var IMAGE_CORE = {
    name: 'image',
    title: 'Image',
    type: null,
...
var ImageType = {
    ...
    extend: function (subTypeDef, extendMember) {
        var options = tslib_es6.__assign({}, (subTypeDef.options || DEFAULT_OPTIONS$3));
        var hotspotFields = [HOTSPOT_FIELD, CROP_FIELD];
        if (!options.hotspot) {
            hotspotFields = hotspotFields.map(function (field) { return (tslib_es6.__assign(tslib_es6.__assign({}, field), { hidden: true })); });
        }
        var fields = tslib_es6.__spreadArray(tslib_es6.__spreadArray([ASSET_FIELD$1], tslib_es6.__read(hotspotFields), false), tslib_es6.__read((subTypeDef.fields || [])), false);
        var parsed = Object.assign(lodash.pick(IMAGE_CORE, OVERRIDABLE_FIELDS$2), subTypeDef, {
            type: IMAGE_CORE,
        ...
        lazyGetter(parsed, 'fields', function () {
            return fields.map(function (fieldDef) {
                var name = fieldDef.name, fieldset = fieldDef.fieldset, type = tslib_es6.__rest(fieldDef, ["name", "fieldset"]);
                return {
                    name: name,
                    fieldset: fieldset,
        ...
        function subtype(parent) {
            return {
                ...
                extend: function (extensionDef) {
                    ...
                    var current = Object.assign({}, parent, lodash.pick(extensionDef, OVERRIDABLE_FIELDS$2), {
                        type: parent,
                    });
                    return subtype(current);
                },
...
var OVERRIDABLE_FIELDS$1 = tslib_es6.__spreadArray([], tslib_es6.__read(DEFAULT_OVERRIDEABLE_FIELDS), false);
var FILE_CORE = {
    name: 'file',
    title: 'File',
    type: null,
...
var FileType = {
    ...
    extend: function (subTypeDef, extendMember) {
        var options = tslib_es6.__assign({}, (subTypeDef.options || DEFAULT_OPTIONS$2));
        var fields = tslib_es6.__spreadArray([ASSET_FIELD], tslib_es6.__read((subTypeDef.fields || [])), false);
        var parsed = Object.assign(lodash.pick(FILE_CORE, OVERRIDABLE_FIELDS$1), subTypeDef, {
            type: FILE_CORE,
            options: options,
            isCustomized: Boolean(subTypeDef.fields),
        });
        ...
        function subtype(parent) {
            return {
                ...
                extend: function (extensionDef) {
                    ...
                    var current = Object.assign({}, parent, lodash.pick(extensionDef, OVERRIDABLE_FIELDS$1), {
                        type: parent,
                    });
                    return subtype(current);
                },
...
var OVERRIDABLE_FIELDS = tslib_es6.__spreadArray([], tslib_es6.__read(DEFAULT_OVERRIDEABLE_FIELDS), false);
var ARRAY_CORE = {
    name: 'array',
    type: null,
    jsonType: 'array',
...
var ArrayType = {
    ...
    extend: function (subTypeDef, createMemberType) {
        var parsed = Object.assign(lodash.pick(ARRAY_CORE, OVERRIDABLE_FIELDS), subTypeDef, {
            type: ARRAY_CORE,
        });
        ...
        function subtype(parent) {
            return {
                ...
                extend: function (extensionDef) {
                    ...
                    var current = Object.assign({}, parent, lodash.pick(extensionDef, OVERRIDABLE_FIELDS), {
                        type: parent,
                    });
                    return subtype(current);
                },
...
var BlockType = {
    ...
    extend: function (subTypeDef, extendMember) {
        var options = tslib_es6.__assign({}, (subTypeDef.options || DEFAULT_OPTIONS$1));
        var marks = subTypeDef.marks, styles = subTypeDef.styles, lists = subTypeDef.lists, of = subTypeDef.of, rest = tslib_es6.__rest(subTypeDef, ["marks", "styles", "lists", "of"]);
        ...
        var parsed = Object.assign(lodash.pick(BLOCK_CORE, INHERITED_FIELDS$1), rest, {
            type: BLOCK_CORE,
            options: options,
        });
        lazyGetter(parsed, 'fields', function () {
        ...
        function subtype(parent) {
            return {
                ...
                extend: function (extensionDef) {
                    ...
                    var current = Object.assign({}, parent, lodash.pick(extensionDef, INHERITED_FIELDS$1), {
                        type: parent,
                    });
                    return subtype(current);
                },
...
function ensureNormalStyle(styles) {
    return styles.some(function (style) { return style.value === 'normal'; })
        ? styles
        : tslib_es6.__spreadArray([BLOCK_STYLES.normal], tslib_es6.__read(styles), false);
}
...
function createChildrenField(marks, of) {
    ...
    return {
        ...
        ], tslib_es6.__read(of.filter(function (memberType) { return memberType.type !== 'span'; })), false),
    };
}
...
var SpanType = {
    ...
    extend: function (subTypeDef, extendMember) {
        var options = tslib_es6.__assign({}, (subTypeDef.options || DEFAULT_OPTIONS));
        ...
        var parsed = Object.assign(lodash.pick(SPAN_CORE, INHERITED_FIELDS), subTypeDef, {
            type: SPAN_CORE,
            options: options,
        });
        lazyGetter(parsed, 'fields', function () {
        ...
        function subtype(parent) {
            return {
                ...
                extend: function (extensionDef) {
                    ...
                    var current = Object.assign({}, parent, lodash.pick(extensionDef, INHERITED_FIELDS), {
                        type: parent,
                    });
                    return subtype(current);
                },
