...
export declare type Visitor = (typeDef: SchemaTypeDef, arg1: VisitContext) => SchemaType;
export declare class UnknownType {
    name: string;
    constructor(name: string);
}
export declare function traverseSchema(types?: SchemaTypeDef[], coreTypes?: SchemaTypeDef[], visitor?: Visitor): {
