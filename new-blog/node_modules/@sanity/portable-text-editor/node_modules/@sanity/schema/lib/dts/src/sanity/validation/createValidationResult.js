...
export var error = function (message, helpId) {
    return createValidationResult('error', message, helpId);
};
export var warning = function (message, helpId) {
    return createValidationResult('warning', message, helpId);
};
export var info = function (message, helpId) {
    return createValidationResult('info', message, helpId);
};
//# sourceMappingURL=createValidationResult.js.map