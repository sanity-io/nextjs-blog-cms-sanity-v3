...
export interface ObjectSchemaType<T extends object = Record<string, any>> extends BaseObjectSchemaType {
...
export declare type SchemaType<A = unknown, O extends object = Record<string, any>> = ArraySchemaType<A> | BooleanSchemaType | NumberSchemaType | ObjectSchemaType<O> | StringSchemaType;
/**
