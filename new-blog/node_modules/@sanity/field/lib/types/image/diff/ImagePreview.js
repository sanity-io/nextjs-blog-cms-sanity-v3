...
var imageBuilder = (0, _imageUrl.default)(_versionedClient.versionedClient);
...
function ImagePreview(props) {
  ...
  if (!(0, _assetUtils.isImageSource)(id)) {
  ...
  var dimensions = (0, _assetUtils.getImageDimensions)(id);
