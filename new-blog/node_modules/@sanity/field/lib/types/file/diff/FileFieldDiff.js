...
var SizeDiff = _styledComponents.default.div(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n  ", "\n  &:not([hidden]) {\n    display: inline-block;\n  }\n\n  [data-number='positive'] {\n    color: var(--size-diff-positive);\n  }\n\n  [data-number='negative'] {\n    color: var(--size-diff-negative);\n  }\n"])), _ref => {
...
var FileFieldDiff = _ref2 => {
  ...
  var fromInvalid = (fromAsset === null || fromAsset === void 0 ? void 0 : fromAsset._ref) && !(0, _assetUtils.isFileSource)(fromAsset === null || fromAsset === void 0 ? void 0 : fromAsset._ref);
  var toInvalid = (toAsset === null || toAsset === void 0 ? void 0 : toAsset._ref) && !(0, _assetUtils.isFileSource)(toAsset === null || toAsset === void 0 ? void 0 : toAsset._ref);
  ...
  var cardStyles = (0, _react.useMemo)(() => ({
    display: 'block',
    flex: 1
  }), []);
  var from = prev && /*#__PURE__*/_react.default.createElement(_diff.DiffCard, {
    ...
    path: "asset._ref",
    style: cardStyles
  }, fromInvalid && /*#__PURE__*/_react.default.createElement(_ui.Card, {
    tone: "caution",
    padding: 4,
    paddingRight: 2,
    border: true,
    ...
    size: 1
  }, /*#__PURE__*/_react.default.createElement(_icons.WarningOutlineIcon, null)), /*#__PURE__*/_react.default.createElement(_ui.Text, {
    size: 1,
    weight: "semibold"
  }, "Invalid file value"))), !fromInvalid && /*#__PURE__*/_react.default.createElement(_diff.MetaInfo, {
  ...
  var to = next && /*#__PURE__*/_react.default.createElement(_diff.DiffCard, {
    ...
    path: "asset._ref",
    style: cardStyles
  }, toInvalid && /*#__PURE__*/_react.default.createElement(_ui.Card, {
    tone: "caution",
    padding: 4,
    paddingRight: 2,
    border: true,
    ...
    size: 1,
    weight: "semibold"
  }, "Invalid file value"))), !toInvalid && /*#__PURE__*/_react.default.createElement(_diff.MetaInfo, {
  ...
  var FileAssetChange = /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, from && !to && /*#__PURE__*/_react.default.createElement(_diff.DiffTooltip, {
    diff: diff,
    path: "asset._ref",
    description: "Removed"
