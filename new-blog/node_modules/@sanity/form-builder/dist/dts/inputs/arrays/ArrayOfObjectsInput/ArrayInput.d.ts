...
export declare function createProtoValue(type: SchemaType): ArrayMember;
...
export declare class ArrayInput extends React.Component<Props> {
    ...
    state: State;
    insert: (item: ArrayMember, position: 'before' | 'after', path: Path) => void;
    handlePrepend: (value: ArrayMember) => void;
    handleAppend: (value: ArrayMember) => void;
    handleInsert: (event: InsertEvent) => void;
