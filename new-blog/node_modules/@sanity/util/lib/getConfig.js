...
var getConfig = function getConfig(rootDir) {
  var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
  var localConfig = rootDir && (0, _safeJson.loadJsonSync)(path.join(rootDir, 'sanity.json'));
  var config = (0, _reduceConfig.default)(localConfig ? (0, _merge2.default)({}, defaults, localConfig) : defaults, options.env || process.env.NODE_ENV || 'development',
