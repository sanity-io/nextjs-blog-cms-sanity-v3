...
var PublishAction = props => {
  ...
  var revision = ((editState === null || editState === void 0 ? void 0 : editState.draft) || (editState === null || editState === void 0 ? void 0 : editState.published) || {})._rev;
  var hasValidationErrors = validationStatus.markers.some(marker => marker.level === 'error');
  // we use this to "schedule" publish after pending tasks (e.g. validation and sync) has completed
  var _useState3 = (0, _react.useState)(false),
    _useState4 = _slicedToArray(_useState3, 2),
    publishScheduled = _useState4[0],
    setPublishScheduled = _useState4[1];
  var isSyncing = syncState.isSyncing;
  var isValidating = validationStatus.isValidating;
  ...
  (0, _react.useEffect)(() => {
    ...
    var validationComplete = validationStatus.isValidating === false && validationStatus.revision !== revision;
  ...
  var disabled = Boolean(publishScheduled || (editState === null || editState === void 0 ? void 0 : (_editState$transactio = editState.transactionSyncLock) === null || _editState$transactio === void 0 ? void 0 : _editState$transactio.enabled) || publishState === 'publishing' || publishState === 'published' || hasValidationErrors || publish.disabled);
  return {
