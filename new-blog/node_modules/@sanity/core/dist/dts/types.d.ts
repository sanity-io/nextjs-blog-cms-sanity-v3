...
export declare type CliPrompter = typeof prompt & {
    Separator: typeof Separator;
    single: <T = string>(question: Omit<DistinctQuestion, 'name'> & {
        choices: string[];
    }) => Promise<T>;
};
export declare type CliApiClient = (options?: {
    requireUser?: boolean;
...
export declare type CliBundledYarn = (args: string[], options?: CliYarnOptions) => Promise<ChildProcessWithoutNullStreams>;
