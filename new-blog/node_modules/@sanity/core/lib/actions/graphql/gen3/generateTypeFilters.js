...
const createBooleanFilters = require('../gen2/filters/booleanFilters');
const createDateFilters = require('../gen2/filters/dateFilters');
const createDatetimeFilters = require('../gen2/filters/dateTimeFilters');
const createFloatFilters = require('../gen2/filters/floatFilters');
const createIdFilters = require('../gen2/filters/idFilters');
const createIntegerFilters = require('../gen2/filters/integerFilters');
const createStringFilters = require('../gen2/filters/stringFilters');
...
function generateTypeFilters(types) {
  ...
  const objectTypes = types.filter(type => type.type === 'Object' && !['Block', 'Span'].includes(type.name) &&
  ...
  const documentTypes = types.filter(type => type.name === 'Document' || type.type === 'Object' && type.interfaces && type.interfaces.includes('Document'));
