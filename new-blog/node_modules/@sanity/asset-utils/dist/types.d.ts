...
export declare type SanityFileSource = string | SanityReference | SanityFileAsset | SanityAssetIdStub | SanityAssetUrlStub | SanityAssetPathStub | SanityFileObjectStub;
export declare type SanityImageSource = string | SanityReference | SanityImageAsset | SanityAssetIdStub | SanityAssetUrlStub | SanityAssetPathStub | SanityImageObjectStub;
export declare type SanitySwatchName = 'darkMuted' | 'darkVibrant' | 'dominant' | 'lightMuted' | 'lightVibrant' | 'muted' | 'vibrant';
...
export interface SanityFileObjectStub {
    _type?: string;
    asset: SanityReference | SanityFileAsset | SanityAssetIdStub | SanityAssetPathStub | SanityAssetUrlStub;
    [key: string]: unknown;
}
export interface SanityImageObjectStub {
    _type?: string;
    asset: SanityReference | SanityImageAsset | SanityAssetIdStub | SanityAssetPathStub | SanityAssetUrlStub;
