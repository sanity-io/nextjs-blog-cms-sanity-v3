...
var _webpackDevMiddleware = _interopRequireDefault(require("@sanity/webpack-dev-middleware"));
...
function getDevServer() {
  ...
  var webpackConfig = config.webpack || (0, _webpackConfig.default)(config);
