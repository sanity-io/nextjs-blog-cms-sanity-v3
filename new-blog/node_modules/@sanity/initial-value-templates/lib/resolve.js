...
function _resolveInitialValue() {
  _resolveInitialValue = _asyncToGenerator(function* (schema, template) {
    ...
    resolvedValue = (0, _validate.validateInitialObjectValue)(resolvedValue, template);

    // Get deep initial values from schema types (note: the initial value from template overrides the types)
    var newValue = (0, _deepAssign.default)((yield (0, _resolveInitialValueForType.resolveInitialValueForType)(schema.get(schemaType), params)) || {}, resolvedValue);
