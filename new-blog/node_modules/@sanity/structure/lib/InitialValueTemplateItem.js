...
function defaultInitialValueTemplateItems() {
  ...
  var templates = (0, _initialValueTemplates.getTemplates)()
  ...
  .filter(tpl => (0, _documentActionUtils.isActionEnabled)(schema.get(tpl.schemaType), 'create'));

  // Sort templates by their schema type, in order or definition
  var typeNames = schema.getTypeNames();
  var ordered = templates.sort((a, b) => typeNames.indexOf(a.schemaType) - typeNames.indexOf(b.schemaType));
