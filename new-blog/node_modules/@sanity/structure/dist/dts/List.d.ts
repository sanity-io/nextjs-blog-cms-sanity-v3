import { SerializeOptions, Divider, Collection } from './StructureNodes';
...
export declare function isList(list: Collection): list is List;
export declare class ListBuilder extends GenericListBuilder<BuildableList, ListBuilder> {
    ...
    getItems(): (ListItem | Divider | ListItemBuilder)[] | undefined;
