 ...
 */
declare function getDocumentValuePermissions({ document, permission, }: DocumentValuePermissionsOptions): Observable<PermissionCheckResult>;
/**
 ...
 */
declare const useDocumentValuePermissions: (args_0: DocumentValuePermissionsOptions) => [PermissionCheckResult, boolean];
export { getDocumentValuePermissions as unstable_getDocumentValuePermissions, useDocumentValuePermissions as unstable_useDocumentValuePermissions, };
