...
export declare type Previewable = Document | Record<string, unknown> | Reference | Id;
export declare type Path = FieldName[];
export declare type Selection = [Id, Path[]];
...
export declare enum AvailabilityReason {
    READABLE = "READABLE",
