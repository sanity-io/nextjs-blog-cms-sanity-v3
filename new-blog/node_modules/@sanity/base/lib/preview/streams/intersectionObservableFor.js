...
function createLegacyBased() {
  ...
  return function intersectionObservableFor(element) {
    ...
    return (0, _rxjs.merge)((0, _rxjs.of)(isElementInViewport()), _resize.default, _scroll.default, _orientationChange.default).pipe((0, _operators.map)(isElementInViewport),
