...
function useTimeAgo(time) {
  ...
  var resolved = formatRelativeTime(time, {
    minimal,
    agoSuffix
  });
  var _useReducer = (0, _react.useReducer)(x => x + 1, 0),
...
function formatRelativeTime(date) {
  ...
  var weekSuffix = (0, _pluralize.default)('week', diffWeeks);
  if (diffWeeks) {
    if (opts.minimal) {
      return {
  ...
  var daysSuffix = (0, _pluralize.default)('days', diffDays);
  if (diffDays) {
    if (opts.minimal) {
    ...
    var daysSince = opts.agoSuffix ? "".concat(diffDays, " ").concat(daysSuffix, " ago") : "".concat(diffDays, " ").concat(daysSuffix);
    return {
  ...
  var hoursSuffix = (0, _pluralize.default)('hour', diffHours);
  if (diffHours) {
    if (opts.minimal) {
      return {
  ...
  var minsSuffix = (0, _pluralize.default)('minute', diffMins);
  if (diffMins) {
    if (opts.minimal) {
      return {
  ...
  var secsSuffix = (0, _pluralize.default)('second', diffSeconds);
  if (diffSeconds > 10) {
    if (opts.minimal) {
      return {
