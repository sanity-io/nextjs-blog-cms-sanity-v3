...
var createObservableBufferedDocument = listenerEvent$ => {
  ...
  var actions$ = new _rxjs.Subject();

  // Stream of commit requests. Must be handled by a commit handler
  var consistency$ = new _rxjs.BehaviorSubject(true);
  ...
  var currentBufferedDocument$ = listenerEvent$.pipe((0, _operators.scan)((bufferedDocument, listenerEvent) => {
    ...
    return bufferedDocument;
  }, null), (0, _operators.distinctUntilChanged)(), (0, _operators.publishReplay)(1), (0, _operators.refCount)());
  ...
  var commit = () => {
    currentBufferedDocument$.pipe((0, _operators.take)(1), (0, _operators.tap)(bufferedDocument => bufferedDocument.commit())).subscribe();
  };
