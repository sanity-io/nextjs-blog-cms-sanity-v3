...
var prefixNamespace = (ns, key) => "".concat(ns, "::").concat(key);
var updates$ = set$.pipe((0, _operators.switchMap)(event => storageBackend.set(event.key, event.value).pipe((0, _operators.map)(nextValue => ({
  key: event.key,
  value: nextValue
})))));
var _listen = (key, defValue) => {
