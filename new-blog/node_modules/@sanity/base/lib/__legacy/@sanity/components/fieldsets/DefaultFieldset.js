...
class Fieldset extends _react.default.PureComponent {
  constructor(props) {
    ...
    _defineProperty(this, "handleKeyDown", event => event.key === 'Enter' ? this.handleToggle() : false);
  ...
  render() {
    ...
    var rootClassName = (0, _classnames.default)(styles.root, styles["columns".concat(columns)], styles["level".concat(level)], transparent && styles.transparent, this.props.onFocus && styles.canFocus, className);

    // Only show a summary of validation issues if field is collapsible and has been collapsed
    var showSummary = isCollapsible && isCollapsed;
    // Hide the tooltip if field is collapsible, but field is not collapsed
    var hideTooltip = isCollapsible && !isCollapsed;
    var childPresence = isCollapsible && isCollapsed ? presence : EMPTY_ARRAY;
    return /*#__PURE__*/_react.default.createElement("div", _extends({}, rest, {
      ...
      className: styles.content
    }, changeIndicator ? /*#__PURE__*/_react.default.createElement(_changeIndicators.ChangeIndicator, changeIndicator === true ? {} : changeIndicator, /*#__PURE__*/_react.default.createElement("div", {
      className: styles.fieldWrapper,
      "data-columns": columns && columns > 1
