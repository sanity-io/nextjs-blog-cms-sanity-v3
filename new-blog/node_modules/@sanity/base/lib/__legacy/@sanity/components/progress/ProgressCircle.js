...
class ProgressCircle extends _react.default.PureComponent {
  componentDidMount() {
    ...
    console.warn("ProgressCircle from `part:@sanity/components/progress/circle` is deprecated. Please use `import {ProgressCircle} from '@sanity/base/components'` instead");
  }
  render() {
