...
exports.applyAgent = function () {
  ...
  var proxy = arguments.length > 1 ? arguments[1] : undefined;
  var options = objectAssign({}, opts); // Setup proxy header exclusive list and whitelist
...
function constructProxyHost(uri) {
  ...
  var proxyHost = "".concat(uri.hostname, ":");
