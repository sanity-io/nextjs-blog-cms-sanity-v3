...
module.exports = (context, callback) => {
  ...
  const timers = {}; // Deep-checking window.location because of react native, where `location` doesn't exist

  const cors = win && win.location && !sameOrigin(win.location.href, options.url); // Allow middleware to inject a response, for instance in the case of caching or mocking
  ...
  let aborted = false;
  let loaded = false;
  let timedOut = false; // Apply event handlers
