...
export default function Model(props) {
  ...
  return (
    <group {...props} dispose={null}>
      ...
      <group position={[-5.24, 6.21, 0.07]} scale={[0.03, 2.88, 2.35]}>
        <mesh
          castShadow
          receiveShadow
